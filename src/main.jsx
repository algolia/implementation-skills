...
const companionTools = [
  {
    ...
    note: 'Signs in through your browser. No API key to copy anywhere.',
    icon: Bot,
  ...
  },
  {
    ...
    description: 'Actually applies the work: updating settings, importing records, editing synonyms and rules. The skills decide what should change; this is what changes it.',
