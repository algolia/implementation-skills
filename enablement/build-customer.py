...
WHEN = [
    ...
    ("You inherited a setup, or it \u201cworks\u201d but nobody has checked it",
     "Captures the live settings and page first, then hunts the defects that never error: inert ranking chains, non-searchable facets, leaked internal fields, dead events.",
     "algolia-audit"),
